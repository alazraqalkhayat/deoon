...
public class SearchMethodeAndInternalPasswordItemsAdapter extends ArrayAdapter<SearchMethodeAndInternalPasswordItems> {


    public SearchMethodeAndInternalPasswordItemsAdapter(@NonNull Context context, List<SearchMethodeAndInternalPasswordItems> brand_of_service_spinner_items) {
    ...
    public View spinnerView(int position,  View convertView,  ViewGroup parent){
        ...
        SearchMethodeAndInternalPasswordItems items=getItem(position);
